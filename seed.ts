...
async function seed() {
  ...
  const settings = [
    ...
    { key: 'couple_story', value: 'Un amour béni par Dieu, uni par la grâce divine et célébré avec tous nos proches. Josué & Hornella, unis pour la vie.' },
    ...
    { key: 'reception_venue', value: 'Salle Polyvalente – Grand Palais Kinshasa' },
    { key: 'contact_email', value: 'contact@josue-hornella.wedding' },
    { key: 'contact_phone', value: '+243 800 000 000' },
    { key: 'rsvp_deadline', value: '2026-05-26' },
