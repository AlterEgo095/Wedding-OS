...
/**
 * Command Center — Users Section
 *
 * Extracted verbatim from the legacy monolithic page.tsx (Phase 0 backup,
 * lines 1260-1750 of `page.tsx.phase0-legacy.bak`). The component renders
 * the platform user management table with search, role filter, pagination,
 * and the create/edit/delete dialogs.
 *
...
import type { PaginatedUsers, PaginatedWeddings, UserRow } from '../../_lib/types'
import { formatDate, RoleBadge } from '../../_lib/ui'

// `getRoleLabel` is exposed by `_lib/ui`'s `RoleBadge` (used in the table cell
// below) — re-imported here for parity with the legacy module surface so any
// future section-specific role rendering stays one import away.
void getRoleLabel
