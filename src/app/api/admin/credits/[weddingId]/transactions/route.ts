...
// /api/platform/credits/[weddingId]/transactions/route. Ce fichier ne fait que ré-exporter les handlers
...
export { GET } from '@/app/api/platform/credits/[weddingId]/transactions/route';
