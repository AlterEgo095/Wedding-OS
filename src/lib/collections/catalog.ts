...
export const COLLECTIONS: PremiumCollection[] = [
  // ─── 1. ROYAL GOLD (100% complete — reference) ───────────────────────────────
  {
    ...
    coverImage: '/collections/royal-gold.png',
    completionPct: 100,
    version: '1.0.0',
  ...
  // ─── 2. ROYAL BLACK ───────────────────────────────────────────────────────────
  {
    ...
    coverImage: '/collections/royal-black.png',
    completionPct: 78,
    version: '0.9.0',
    designer: 'Studio Heureux Mariage',
  ...
  // ─── 3. WHITE ROMANCE ─────────────────────────────────────────────────────────
  {
    ...
    coverImage: '/collections/white-romance.png',
    completionPct: 72,
    version: '0.8.0',
    designer: 'Studio Heureux Mariage',
  ...
  // ─── 4. KENTE PRESTIGE ────────────────────────────────────────────────────────
  {
    ...
    coverImage: '/collections/kente-prestige.png',
    completionPct: 65,
    version: '0.7.0',
    designer: 'Studio Heureux Mariage',
  ...
  // ─── 5. BEACH LUXURY ──────────────────────────────────────────────────────────
  {
    ...
    coverImage: '/collections/beach-luxury.png',
    completionPct: 68,
    version: '0.7.0',
    designer: 'Studio Heureux Mariage',
